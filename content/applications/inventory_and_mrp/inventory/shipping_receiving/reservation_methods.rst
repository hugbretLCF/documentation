...
Companies that sell and deliver goods to customers need to make sure that they always have stock
on-hand, so when new sales orders are confirmed, they can deliver products on time.
...
In the :guilabel:`General` tab, locate the :guilabel:`Reservation Method` option, and choose which
method should be used for this type of operation.
...
.. note::
   ...
   *resupply subcontractor* orders, *repairs* orders, and *internal transfers*. To enable this,
   configure the additional settings:

   - **For manufacturing orders:** Install the *Manufacturing* application by going to
     :menuselection:`Apps`, locating the *Manufacturing* app, and clicking :guilabel:`Install`.
   ...
   - **For repairs:** Install the *Repairs* application by going to :menuselection:`Apps`, locating
     the *Repairs* app, and clicking :guilabel:`Install`.
